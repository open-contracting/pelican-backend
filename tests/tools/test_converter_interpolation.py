...
def test_interpolation():
    with patch.object(currency_converter, "settings", new=InterpolationNone):
        cc = currency_converter.ExchangeRates(item_test_interpolation1)
    ...
    with patch.object(currency_converter, "settings", new=InterpolationClosest):
        cc = currency_converter.ExchangeRates(item_test_interpolation1)
    ...
    with patch.object(currency_converter, "settings", new=InterpolationClosestWithMaxDays):
        cc = currency_converter.ExchangeRates(item_test_interpolation2)
    ...
    with patch.object(currency_converter, "settings", new=InterpolationLinear):
        cc = currency_converter.ExchangeRates(item_test_interpolation1)
    ...
    with patch.object(currency_converter, "settings", new=InterpolationLinearWithMaxDays):
        cc = currency_converter.ExchangeRates(item_test_interpolation2)
