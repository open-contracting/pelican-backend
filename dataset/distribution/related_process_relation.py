...
class RelatedProcessRelationPathClass:
    """ PathClass for relatedProcess.relation.distribution checker
    ...
    def __init__(self, number_of_samples=20):
        ...
        """
        self.path = "relatedProcess.relationship"
    ...
    def get_result(self, scope):
        res = get_result(scope, important_values=self.important_enums)
        return res
