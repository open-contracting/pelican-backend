...
def test_multiple_contracts():
    ...
    assert result['meta'] == [{'path': 'contracts.period', 'index': 0, 'result': True},
                              {'path': 'contracts.period', 'index': 1, 'result': True},
                              {'path': 'contracts.period', 'index': 2, 'result': True}]
...
def test_one_fail():
    ...
    assert result['meta'] == [{'path': 'tender.awardPeriod', 'index': 0, 'result': False}]
...
def test_mixed_time_zones():
    ...
    assert result['meta'] == [{'path': 'tender.tenderPeriod', 'index': 0, 'result': True}]
...
def test_multiple_fails_and_passes():
    ...
    assert result['meta'] == [{'path': 'awards.contractPeriod', 'index': 0, 'result': True}, \
                              {'path': 'awards.contractPeriod', 'index': 1, 'result': True}, \
                              {'path': 'awards.contractPeriod', 'index': 2, 'result': False}]
