...
calculate_buyer = functools.partial(
    calculate,
    path="buyer"
)
...
calculate_tender_tenderers = functools.partial(
    calculate,
...
calculate_awards_suppliers = functools.partial(
    calculate,
