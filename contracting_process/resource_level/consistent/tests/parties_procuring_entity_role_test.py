...
correct_item_with_procuringEntity = {
    "parties": [
        {
...
incorrect_item_with_procuringEntity = {
    "parties": [
        {
            "id": "010101-a01010",  # empty list of roles
            "name": "Uni",
...
def test_correct_tender_procuring_entity():
    ...
    result = calculate_prepared(correct_item_with_procuringEntity)
    assert expecting_result == result
...
def test_incorrect_tender_procuring_entity():
    ...
    result1 = calculate_prepared(incorrect_item_with_procuringEntity)
