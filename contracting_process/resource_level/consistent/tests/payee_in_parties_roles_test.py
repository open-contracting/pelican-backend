...
item_test_undefined2 = {"parties": [{"id": "0"}], "contracts": [{"implementation": {"transactions": [{"payee": {}}]}}]}

item_test_undefined3 = {
    "parties": [{"id": "0"}, {"id": "0"}],
    "contracts": [{"implementation": {"transactions": [{"payee": {"id": "0"}}]}}],
}
...
item_test_failed2 = {
    "parties": [{"id": "0", "roles": ["payee"]}, {"id": "1"}, {"id": "2", "roles": ["unknown"]}],
    "contracts": [
        {"implementation": {"transactions": [{"payee": {"id": "0"}}]}},
        {"implementation": {"transactions": [{"payee": {"id": "1"}}, {"payee": {"id": "2"}}]}},
    ],
}
