...
definitions = {
    ...
    "contracts.implementation.transactions.providerOrganization": [(identifier_scheme.calculate, identifier_scheme.name)],
    ...
    "contracts.implementation.transactions.receiverOrganization": [(identifier_scheme.calculate, identifier_scheme.name)],
