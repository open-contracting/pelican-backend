...
definitions = {
    ...
    "awards.suppliers.id": [],
    "awards.suppliers.identifier": [(identifier_scheme.calculate, identifier_scheme.name)],
    ...
    "awards.suppliers.additionalIdentifiers": [(identifier_scheme.calculate, identifier_scheme.name)],
