...
config_data = {
    "docker": {
        ...
        "extractor_max_batch_size": int(os.getenv("EXTRACTOR_MAX_BATCH_SIZE", "0")),
        ...
        "kf_extractor_max_size": int(os.getenv("KF_EXTRACTOR_MAX_SIZE", "0")),
        ...
        "currency_converter_interpolation_max_days_fallback": int(
            os.getenv("CURRENCY_CONVERTER_INTERPOLATION_MAX_DAYS_FALLBACK", "0")
        ),
        "currency_converter_extrapolation_max_days_fallback": int(
            os.getenv("CURRENCY_CONVERTER_EXTRAPOLATION_MAX_DAYS_FALLBACK", "0")
        ),
