...
CREATE TABLE progress_monitor_dataset ( id BIGSERIAL PRIMARY KEY,
                                                             dataset_id character varying(255),
                                                                                  state character varying(255),
                                                                                                  phase character varying(255),
                                                                                                                  size integer, created timestamp without time zone,
...
ALTER TABLE progress_monitor_dataset ADD CONSTRAINT unique_dataset_id UNIQUE USING INDEX progress_monitor_dataset_dataset_id_idx;


CREATE TABLE progress_monitor_item ( id BIGSERIAL PRIMARY KEY,
                                                          dataset_id character varying(255),
...
ALTER TABLE progress_monitor_item ADD CONSTRAINT unique_dataset_id_item_id UNIQUE USING INDEX unique_dataset_id_item_id;


CREATE TABLE data_item ( id BIGSERIAL PRIMARY KEY,
                                              data jsonb,
                                                   dataset_id character varying(255),
                                                                        created timestamp without time zone,
                                                                                                       modified timestamp without time zone);
...
CREATE TABLE field_level_check ( id BIGSERIAL PRIMARY KEY,
                                                      path character varying, result boolean, meta jsonb,
                                                                                              data_item_id bigint, dataset_id character varying(255),
                                                                                                                                        created timestamp without time zone,
                                                                                                                                                                       modified timestamp without time zone);
...
CREATE TABLE resource_level_check ( id BIGSERIAL PRIMARY KEY,
                                                         check_name character varying, result boolean, pass_count int, application_count int, meta jsonb,
                                                                                                                                              data_item_id bigint, dataset_id character varying(255),
                                                                                                                                                                                        created timestamp without time zone,
                                                                                                                                                                                                                       modified timestamp without time zone);
...
CREATE TABLE dataset_level_check ( id BIGSERIAL PRIMARY KEY,
                                                        check_name character varying, result boolean, value int, meta jsonb,
                                                                                                                 dataset_id character varying(255),
                                                                                                                                      created timestamp without time zone,
                                                                                                                                                                     modified timestamp without time zone);
...
CREATE TABLE exchange_rates ( id BIGSERIAL PRIMARY KEY,
...
FROM './tools/exchange_rates_dump.csv'
